...
def disable():
    if r.get()==1:
        ...
        name = Label(frame_1, text = "Name of Defaulter:", relief = RAISED, fg = "white", bg = "#3b404e", bd = 0 , font = ("Calibri",12), padx= 20, pady = 5)
        ...
        name_book = Label(frame_1, text = "Name of Book:", relief = RAISED, fg = "white", bg = "#3b404e", bd = 0 , font = ("Calibri",12), padx= 20, pady = 5)
        ...
        radio_button_3 = Radiobutton(frame_1, text = "pay original price", font = ("Calibri",12), width = 16, fg = "white", bg = "#3b404e",selectcolor = "#3b404e", activebackground = "#3b404e", variable = r_2, value = 3, command = disable_2)
        radio_button_3.grid(row = 5, column = 0, pady = 10)

        #radio button 4 for add new book
        radio_button_4 = Radiobutton(frame_1, text = "add new book", font = ("Calibri",12), width = 16, fg = "white", bg = "#3b404e", selectcolor = "#3b404e", activebackground = "#3b404e", anchor = "w", variable = r_2, value = 4, command = disable_2)
        radio_button_4.grid(row = 5, column = 1, pady = 10)


#radio button 1 for late submission
radio_button_1 = Radiobutton(frame_1, text = "defaulter's list", font = ("Calibri",12), width = 16, fg = "white", bg = "#3b404e",selectcolor = "#3b404e", activebackground = "#3b404e", anchor = "sw", variable = r, value = 1, command = disable)
