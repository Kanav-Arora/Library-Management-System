...
fault.grid(row = 1, column = 0,padx=50, pady=5)
...
radio_button_1.grid(row=1, column=1, padx=50, pady=5)
...
radio_button_2.grid(row=2, column=1, padx=50, pady=5)
...
next_button.grid(row = 3, column = 0, columnspan = 2, pady=30)
