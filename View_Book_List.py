...
#Label
Label(main_Frame, text="%-30s%-30s%-30s" % ('Title', 'Author', 'Status'),bg="#3b404e", fg='white', width=48).grid(pady=2, row=0)
Label(main_Frame, text="--------------------------------------------------------------------", bg="#3b404e", fg='white').grid(pady=2, row=1)

my_list = [["Harry Potter", "J.K Rowling", "Yes"],["Invisible Man", "H.G Wells", " No"],["Dracula", "Bram Stockes", "Yes"], ["Beloved", "Toni M.", "  Yes"]]


#try:
y = 3
for i in my_list:
    Label(main_Frame, text="%-30s%-30s%-30s" % (i[0], i[1],i[2]), bg="#3b404e", fg='white', width=48).grid(pady=5, row=y)
    y += 1
